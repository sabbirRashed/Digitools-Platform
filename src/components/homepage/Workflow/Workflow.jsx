        ...
        <div className='bg-linear-to-r from-[#4F39F6] to-[#9514FA]'>
            <div className='w-11/12 mx-auto py-15 md:py-30  text-white text-center space-y-4'>
                ...
                <div className='flex justify-center gap-2 mt-10'>
                    <button className='btn rounded-full shadow-none text-[#9514FA]'>Explore Products</button>
                    <button className='btn rounded-full bg-transparent shadow-none text-white hover:bg-linear-to-r from-[#4F39F6] to-[#9514FA] hover:text-white'>View Pricing</button>
                </div>
