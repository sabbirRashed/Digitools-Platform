...
const SelectedPremiumTools = ({ selectedTools, setSelectedTools, price, setPrice }) => {
    ...
    return (
        <div className='border-2 border-[#F2F2F2] rounded-lg p-6 space-y-6'>
            ...
            <button className='btn p-5 font-extrabold w-full bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white rounded-full hover:from-[#6C5BFF] hover:to-[#B23CFF]'>Proceed to Checkout</button>
        </div>
    );
};
