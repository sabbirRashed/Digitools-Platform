                ...
                <div className="navbar-end items-center gap-2 font-medium">
                    ...
                    <span
                        ...
                        <ul className={`absolute bg-base-200 p-4 rounded-sm border border-gray-200 duration-800 space-y-1
                            ...
                            <li><li><button className='btn px-9 py-1 rounded-[1000px] bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white text-[1rem] cursor-pointer hover:from-[#6C5BFF] hover:to-[#B23CFF]'>Login</button></li></li>
